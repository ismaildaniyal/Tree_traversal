...
PROGRAM: ./test_mazesolve_funcs maze_bfs_iterate3
-------------------------------------------------
To run this individual test in GDB use the command:
  gdb --args ./test_mazesolve_funcs maze_bfs_iterate3
...
```sdiff
===EXPECT===                                                             ===ACTUAL===
IF_TEST("maze_bfs_iterate3") {                                         . IF_TEST("maze_bfs_iterate3") {
    ...
    // to obtain paths to each one from the start tile. A larger maze  .     // to obtain paths to each one from the start tile. A larger maze
    // is used where the end tile is not the last tile to be visited   .     // is used where the end tile is not the last tile to be visited
    // during BFS.                                                     .     // during BFS.
...
The program is run on under valgrind as
  stdbuf -i 0 -o 0 -e 0 valgrind --error-exitcode=13 --leak-check=full --show-leak-kinds=all --track-origins=yes ./test_mazesolve_funcs maze_bfs_iterate3
which may be pasted onto a command line to run it.

```
==15548== Memcheck, a memory error detector
==15548== Copyright (C) 2002-2022, and GNU GPL'd, by Julian Seward et al.
==15548== Using Valgrind-3.22.0 and LibVEX; rerun with -h for copyright info
==15548== Command: ./test_mazesolve_funcs maze_bfs_iterate3
==15548== 
==15548== 
==15548== HEAP SUMMARY:
==15548==     in use at exit: 0 bytes in 0 blocks
==15548==   total heap usage: 60 allocs, 60 frees, 2,928 bytes allocated
==15548== 
==15548== All heap blocks were freed -- no leaks are possible
==15548== 
==15548== For lists of detected and suppressed errors, rerun with: -s
